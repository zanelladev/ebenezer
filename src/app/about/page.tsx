            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-warm-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-8 sm:mt-12">
                            {AboutResources.values.items.map((value, index) => (
                                <div key={index} className="bg-white p-6 sm:p-8 rounded-xl shadow-lg">
                                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-primary-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                                    ...
                                    <h3 className="font-serif text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 text-center">
                                        {value.title}
                                    </h3>
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-primary-600 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <p className="text-base sm:text-lg lg:text-xl mb-6 sm:mb-8 text-primary-50">
                            Adoraríamos conhecer você! Venha experimentar o que torna Ebenézer um lugar especial.
                        </p>
                        <Link
                            href="/events"
                            className="inline-block bg-white text-primary-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-primary-50 transition-colors font-medium text-base sm:text-lg"
                        >
